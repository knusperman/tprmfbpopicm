...
\end{figure}
	...
	Outsourcing can involve the transfer of personnel, infrastructure or licensing agreements for instance. The decrease of information asymmetries between provider and prospect helps the provider to compile a more detailed offer. Due diligence is the provider's act to collect this knowledge, so that risks can be minimized by depending less on assumptions. This detail process aims at including more information from the client side in the sales process. 
	...
	The sixth step of selling (close) describes the agreement of selling and buying party. In \acrshort{BPO} this document is the contract between provider and client. Previous negotiations, information from due diligence and the commercial deal are foundations for setup of the contract. This detail process ends with the signing of the contract, which leads to the transition phase of the outsourcing life cycle. The seventh step of selling (follow-up) is represented in the Account Management process that covers the development of an existing outsourcing relationship. 
