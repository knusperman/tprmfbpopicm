...
\chapter{Research Background}
	...
	%%%%%%%%%%
		...
		\begin{itemize}
			...
			\item fields // processes #29 for India, Deloitte Outsourcing Paper
			\item challenges
			\item
		\end{itemize}
		...
		\begin{itemize}
			\item 
			\item 
			\item #29: intro to firms, transaction costs so on
			\item #29: capabilities of Providers
		\end{itemize}
		%%%%%%%%%%
...
\begin{itemize}
	...
	\item warum wende ich SDR hier an?
